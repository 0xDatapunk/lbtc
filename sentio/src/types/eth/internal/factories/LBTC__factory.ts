...
import type { LBTC, LBTCInterface } from "../LBTC.js";
...
export class LBTC__factory {
  static readonly abi = _abi;
  static createInterface(): LBTCInterface {
    return newInterface(_abi) as LBTCInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): LBTC {
    return newContract(address, _abi, signerOrProvider) as LBTC;
  }
}
